    ...
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                <button type="button" class="w-10 layout-topbar-action" (click)="toggleDarkMode()">
                    <i [ngClass]="{ 'pi ': true, 'pi-moon': layoutService.isDarkTheme(), 'pi-sun': !layoutService.isDarkTheme() }"></i>
                </button>
                <div class="relative">
                    <button
                        class="w-10 layout-topbar-action layout-topbar-action-highlight"
                        pStyleClass="@next"
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button type="button" class="layout-topbar-action layout-topbar-action-highlight layout-topbar-action-rounded" (click)="logout()">
...
export class AppTopbar {
    ...
    ngOnInit() {
        ...
        if (storageUsername) {
            ...
            this.router.navigate(['/auth/login']); // Redirect to login if no username found
        }
    }
